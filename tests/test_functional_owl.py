...
from functional_owl.dsl import (
    IdentifierBox,
...
from functional_owl.ontology import get_rdf_graph_oracle
from functional_owl.utils import EXAMPLE_PREFIX_MAP, get_rdf_graph
